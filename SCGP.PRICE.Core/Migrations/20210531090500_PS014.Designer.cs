...
namespace SCGP.PRICE.Core.Migrations
{
    ...
    [Migration("20210531090500_PS014")]
    partial class PS014
    {
            ...
            modelBuilder.Entity("SCGP.PRICE.Models.pr_formula_variable", b =>
                {
                    ...
                    b.Property<int?>("pr_formula_groupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SCGP.PRICE.Models.pr_formula", b =>
                {
                    ...
                    b.HasOne("SCGP.PRICE.Models.pr_formula", null)
                        .WithMany("formulas")
                        .HasForeignKey("pr_formulaId");
            ...
            modelBuilder.Entity("SCGP.PRICE.Models.pr_formula_variable", b =>
                {
                    ...
                    b.HasOne("SCGP.PRICE.Models.pr_formula_group", null)
                        .WithMany("formula_variables")
                        .HasForeignKey("pr_formula_groupId");
